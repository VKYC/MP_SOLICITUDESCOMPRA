...
class PurchaseOrder(models.Model):
    ...
    limit_config_id = fields.Many2one('purchase.limit.config', string='Configuración de Límite', default=lambda self: self.env['purchase.limit.config'].search([], limit=1).id)
